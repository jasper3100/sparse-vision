...
if __name__ == "__main__":
    ...
    activations_file_path = os.path.join(activations_folder_path, f'{layer_name}_intermediate_activations.h5')
    ...
    # NPZ
    start_time = time.time()
    activations_file_path = os.path.join(activations_folder_path, f'{layer_name}_intermediate_activations.npz')
